    ...
    var body: some View {
        ...
        ZStack(alignment: .leading) {
            ...
            RoundedRectangle(cornerRadius: 20)
                ...
                .frame(width: 150*CGFloat(currentProgress), height: 15)
        }
...
//        ProgressBarView(currentProgress: 0.0, endProgress: 0.6, barColor: .gray, barOpacity: 0.7, progressBarColor: .red, progressBarOpacity: 0.7, load: false)
//    }
//}
