...
struct MailView: View {
    @State private var mailData = ComposeMailData(subject: "TriOlympic Review", recipients: ["team@trihardapps.com"], message: "")
